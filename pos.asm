...
;---REMOVE MEMBER
	MEMBER_REMV_M1 DB 10, 13, "CONFIRM TO REMOVE STAFF: $"
	MEMBER_REMV_M2 DB " ???"
		   		   DB 10, 13, "1. YES"
		   		   DB 10, 13, "2. NO "
		   		   DB 10, 13, 10, 13, "CHOICE: $"
...
MEMBER_REMOVE PROC NEAR
	...
	PRINT MEMBER_M1                                 
    MOV AH, 0AH 			;CAPTURE STRING FROM KEYBOARD.
    MOV DX, OFFSET STF_PHONE_REMOVE
    INT 21H  

	;CHANGE CHR(13) BY '$'.
    MOV SI, OFFSET MEMBER_IPHONE_REMOVE+ 1 ;NUMBER OF CHARACTERS ENTERED.
    MOV CL, [SI] ;MOVE LENGTH TO CL.
    MOV CH, 00      ;CLEAR CH TO USE CX. 
    INC CX ;TO REACH CHR(13).
    ADD SI, CX ;NOW SI POINTS TO CHR(13).
	...
	MEMBER_REMOVE1:
    	...
    	MOV AH, 9 					;DISPLAY STRING.
    	MOV DX, OFFSET MEMBER_IC_REMOVE + 2	;MUST END WITH '$'.
   		INT 21H
		              
    	MOV AH, 9 					;DISPLAY STRING.
    	MOV DX, OFFSET MEMBER_PHONE_REMOVE + 2	;MUST END WITH '$'.
   		INT 21H
